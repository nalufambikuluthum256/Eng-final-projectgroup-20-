...
export function useBearImages(): BearImages {
  ...
  useEffect(() => {
    ...
    const watchImages = import.meta.glob<ImageModule>("../assets/img/watch_bear_*.png", { eager: true });
    const hideImages = import.meta.glob<ImageModule>("../assets/img/hide_bear_*.png", { eager: true });
    const peakImages = import.meta.glob<ImageModule>("../assets/img/peak_bear_*.png", { eager: true });
